//! G3-PLC 6LoWPAN Adaptation Layer Setup Interface (IC 92)
//!
//! G3-PLC 6LoWPAN adaptation layer setup.
//!
//! Reference: IEC 62056-6-2 (Blue Book Part 2) §7.7.92
...
/// G3-PLC 6LoWPAN Adaptation Layer Setup Interface Class (IC 92)
///
/// Attributes:
...
impl CosemClass for G3SixlowpanSetup {
    const CLASS_ID: u16 = 92;
    const VERSION: u8 = 4;
...
mod tests {
    ...
    #[test]
    fn test_class_id() {
        assert_eq!(G3SixlowpanSetup::CLASS_ID, 92);
        assert_eq!(G3SixlowpanSetup::VERSION, 4);
    }
}
