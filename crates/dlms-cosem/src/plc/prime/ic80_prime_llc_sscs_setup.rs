//! PRIME LLC SSCS Setup Interface (IC 80)
//!
//! PRIME NB OFDM PLC LLC SSCS setup.
//!
//! Reference: IEC 62056-6-2 (Blue Book Part 2) §7.7.80
...
/// PRIME LLC SSCS Setup Interface Class (IC 80)
///
/// Attributes:
...
impl CosemClass for PrimeLlcSscsSetup {
...
mod tests {
    ...
    #[test]
    fn test_class_id() {
        assert_eq!(PrimeLlcSscsSetup::CLASS_ID, 80);
    }
}
