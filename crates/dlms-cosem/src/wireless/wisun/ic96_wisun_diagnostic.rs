//! Wi-SUN Diagnostic Interface (IC 96)
//!
//! Wi-SUN diagnostic counters.
//!
//! Reference: IEC 62056-6-2 (Blue Book Part 2) §7.7.96
...
/// Wi-SUN Diagnostic Interface Class (IC 96)
///
/// Attributes:
/// - 1: logical_name (octet-string)
/// - 2: tx_packets (double-long-unsigned)
/// - 3: rx_packets (double-long-unsigned)
/// - 4: tx_failures (double-long-unsigned)
///
/// Methods:
/// - 1: reset
#[derive(Debug, Clone)]
...
impl CosemClass for WisunDiagnostic {
    const CLASS_ID: u16 = 96;
    const VERSION: u8 = 0;
    ...
    fn get_attribute(&self, id: u8) -> Result<DlmsType, CosemError> {
        match id {
            ...
            4 => Ok(DlmsType::UInt32(self.tx_failures)),
...
mod tests {
    ...
    #[test]
    fn test_class_id() {
        assert_eq!(WisunDiagnostic::CLASS_ID, 96);
    }
}
