...
impl LoadProfile {
    ...
    pub fn interval(&self) -> FreezeInterval {
        self.interval
    }
    pub fn set_interval(&mut self, i: FreezeInterval) {
        self.interval = i;
    }
    ...
    pub fn try_freeze(&mut self, record: &FreezeRecord) -> bool {
        ...
        let elapsed = (record.timestamp - self.last_freeze)
            .num_seconds()
            .unsigned_abs() as u32;
    ...
    pub fn to_csv(&self) -> String {
        let mut csv =
            String::from("timestamp,wh_active,wh_reactive,va,vb,vc,ia,ib,ic,max_demand,tariff\n");
        for r in &self.buf {
            csv.push_str(&format!(
                "{},{},{},{},{},{},{},{},{},{},{}\n",
    ...
    pub fn records(&self) -> &[FreezeRecord] {
        &self.buf
    }
