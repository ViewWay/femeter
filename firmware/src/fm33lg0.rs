...
pub fn gpioa() -> &'static GpioRegs {
    reg!(base::GPIOA, GpioRegs)
}
pub fn gpiob() -> &'static GpioRegs {
    reg!(base::GPIOB, GpioRegs)
}
pub fn gpioc() -> &'static GpioRegs {
    reg!(base::GPIOC, GpioRegs)
}
pub fn gpiod() -> &'static GpioRegs {
    reg!(base::GPIOD, GpioRegs)
}
pub fn gpio_common() -> &'static GpioCommonRegs {
    reg!(base::GPIO_COMMON, GpioCommonRegs)
}

pub fn uart0() -> &'static UartRegs {
    reg!(base::UART0, UartRegs)
}
pub fn uart1() -> &'static UartRegs {
    reg!(base::UART1, UartRegs)
}
pub fn uart4() -> &'static UartRegs {
    reg!(base::UART4, UartRegs)
}
pub fn uart5() -> &'static UartRegs {
    reg!(base::UART5, UartRegs)
}
pub fn uartir() -> &'static UartirRegs {
    reg!(base::UARTIR, UartirRegs)
}
pub fn lpuart0() -> &'static LpuartRegs {
    reg!(base::LPUART0, LpuartRegs)
}
pub fn lpuart1() -> &'static LpuartRegs {
    reg!(base::LPUART1, LpuartRegs)
}

pub fn spi0() -> &'static SpiRegs {
    reg!(base::SPI0, SpiRegs)
}
pub fn spi1() -> &'static SpiRegs {
    reg!(base::SPI1, SpiRegs)
}
pub fn spi2() -> &'static SpiRegs {
    reg!(base::SPI2, SpiRegs)
}

pub fn i2c0() -> &'static I2cRegs {
    reg!(base::I2C0, I2cRegs)
}
pub fn lcd() -> &'static LcdRegs {
    reg!(base::LCD, LcdRegs)
}
pub fn rtc() -> &'static RtcRegs {
    reg!(base::RTC, RtcRegs)
}
pub fn iwdt() -> &'static IwdtRegs {
    reg!(base::IWDT, IwdtRegs)
}
pub fn wwdt() -> &'static WwdtRegs {
    reg!(base::WWDT, WwdtRegs)
}
pub fn aes() -> &'static AesRegs {
    reg!(base::AES, AesRegs)
}
pub fn trng() -> &'static TrngRegs {
    reg!(base::TRNG, TrngRegs)
}
pub fn adc() -> &'static AdcRegs {
    reg!(base::ADC, AdcRegs)
}
pub fn dma() -> &'static DmaRegs {
    reg!(base::DMA, DmaRegs)
}
pub fn cmu() -> &'static CmuRegs {
    reg!(base::CMU, CmuRegs)
}
pub fn rmu() -> &'static RmuRegs {
    reg!(base::RMU, RmuRegs)
}
pub fn pmu() -> &'static PmuRegs {
    reg!(base::PMU, PmuRegs)
}
pub fn bstim() -> &'static BstimRegs {
    reg!(base::BSTIM, BstimRegs)
}
pub fn lptim() -> &'static LptimRegs {
    reg!(base::LPTIM, LptimRegs)
}
